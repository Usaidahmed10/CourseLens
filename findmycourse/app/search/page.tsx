...
import { ProgressBar } from './_components.tsx/progressbar'
import { DifficultyMeter } from './_components.tsx/difficultymeter'
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card'
import { useState } from 'react'
import { Bookmark, ChevronRight } from "lucide-react" // or you can use any other icon library
                    ...
                    <div className="w-full" >
                        <div className="flex items-center gap-2">
                            <Image
                                ...
                                width={24}
                                height={24}
                            // className="w-6 h-6 [filter:invert(92%)_sepia(64%)_saturate(1095%)_hue-rotate(329deg)_brightness(102%)_contrast(94%)]"
                            />
                                                                ...
                                                                <div className="flex items-start justify-between">
                                                                    <div>
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <div className="text-green-500">
                                                                                <svg
                                                                                    className="w-5 h-5" // Changed from w-4 h-4
                                                                                    fill="none"
                                                                                    stroke="currentColor"
                                                                                    viewBox="0 0 24 24"
                                                                                >
